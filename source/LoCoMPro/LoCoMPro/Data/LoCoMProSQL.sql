...
-- Triggers que se activan cuando hay un insert a la tabla de registro o a la tabla de reviews. Cuando un usuario tiene más de 10 registros y su promedio de calificación para esos registros es mayor a 4.7 se le asigna el rol de moderador.
GO
...
GO
CREATE TRIGGER UpdateUserRoleOnReview
ON Review
AFTER INSERT
AS
BEGIN
